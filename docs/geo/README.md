...
- **templates/**
  - [template-bairro.md](templates/template-bairro.md) — página `/bairros/{slug}` (M3)
...
M0 entregue como **proposta**. O tick oficial no `PRD_MKT_GEO.md` ocorre apenas após
confirmação explícita do responsável (regra `AGENTS.md`).
</content>
